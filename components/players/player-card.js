...
export default function PlayerCard({ name, id, onRemovePlayer }) {
  const handleOnRemovePlayer = (e) => {
    e.preventDefault();
    onRemovePlayer(id);
  };
  return (
    <Row className="align-items-center">
      ...
      <Col xs="9" sm="6" md="7" className={`${styles.playerCard}`}>
        {name}
      </Col>
      <Col xs="3" sm="4" md="3">
        <Button block variant="danger" onClick={handleOnRemovePlayer}>
          <BsFileMinus className="mr-sm-2" />
